...
export class ProdTables1623022446930 implements MigrationInterface {
    name = 'ProdTables1623022446930'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" character varying(16) NOT NULL, "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "role" "user_role_enum" NOT NULL DEFAULT 'USER', "email" character varying(255) NOT NULL, "password" character varying(60), "name" character varying(255), "emailConfirmationCode" character varying(255), "passwordResetCode" character varying(255), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
