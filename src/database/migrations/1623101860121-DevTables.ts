...
export class DevTables1623101860121 implements MigrationInterface {
    name = 'DevTables1623101860121'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "users_status_enum" AS ENUM('ACTIVE', 'EXPIRED', 'LOGOUT')`);
        await queryRunner.query(`CREATE TABLE "users" ("id" character varying(16) NOT NULL, "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "role" "users_role_enum" NOT NULL DEFAULT 'USER', "userName" character varying(20) NOT NULL, "password" character varying(60), "name" character varying(255), "passwordResetCode" character varying(255), "token" character varying(36) NOT NULL, "status" "users_status_enum" NOT NULL DEFAULT 'ACTIVE', CONSTRAINT "UQ_226bb9aa7aa8a69991209d58f59" UNIQUE ("userName"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "client_addresses_address" ADD CONSTRAINT "FK_b0c70e7d6fe77edf5d86a143518" FOREIGN KEY ("clientId") REFERENCES "client"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "client_addresses_address" ADD CONSTRAINT "FK_1dac714682a85fcee7e58cf4865" FOREIGN KEY ("addressId") REFERENCES "address"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
